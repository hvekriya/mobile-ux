...
$('.add-fav-btn').click(function () {
  ...
  localStorage.setItem(key, $('.ui-page-active .student-name').text())
  $('.add-fav-btn').hide()
  $('.remove-fav-btn').show()
})
...
tinysort('ul.students-list>li', {order: 'asc'})

$('.location-filter').change(function () {
  $('.students-list').removeClass('ui-corner-all')
  var selectedLocation = $(this).val()
  var list = $('.students li')
...
$('.sort-asc-desc').change(function () {
  ...
  if ($(this).val() == 'asc') {
    ...
    tinysort('ul.students-list>li', {order: 'desc'})
  }
})
